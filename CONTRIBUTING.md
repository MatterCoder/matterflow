...
[submitting a GitHub Issue](https://github.com/MatterCoder/matterflow/issues/new).
...
you can
[submit a Pull Request](https://github.com/MatterCoder/matterflow/blob/master/CONTRIBUTING.md#submitting-a-pull-request)
with a fix.
...
-   _Large feature_: first
    [submit a GitHub Issue]https://github.com/MatterCoder/matterflow/issues/new)
...
-   _Small feature_: can be implemented and directly
    [submitted as a Pull Request](https://github.com/MatterCoder/matterflow/blob/master/CONTRIBUTING.md#submitting-a-pull-request).
...
1. Fork the [Matterflow repository](https://github.com/MatterCoder/matterflow)
...
[Doxygen Best Practices, Conventions, and Style](https://github.com/MatterCoder/matterflow/blob/master/docs/style/DOXYGEN.adoc)
...
[Documentation Style Guide](https://github.com/MatterCoder/matterflow/blob/master/docs/STYLE_GUIDE.md)
