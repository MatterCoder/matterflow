...
```
docker run --privileged  --rm --add-host="localhost:172.17.0.1" -p 4173:4173 -p 5173:5173 -p 8000:8000 -p 9001:9001 -p 5010:5010  -v /data:/tmp:rw  -v /config:/config oideibrett/image-amd64-matterflow:0.0.1
```
